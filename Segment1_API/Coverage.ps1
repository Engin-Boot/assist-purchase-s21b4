...
$report = Get-Content -Path Segment1_API\BackendTests\TestResults\*\coverage.cobertura.xml | Out-String
Write-Host "---------------------------------"
Write-Host "Code Coverage report of BackendTest..." 
Write-Host "---------------------------------"
...
Write-Host ""
Write-Host "---------------------------------"
Write-Host "Code Coverage report Analysis of BackendTest..." 
Write-Host "---------------------------------"
