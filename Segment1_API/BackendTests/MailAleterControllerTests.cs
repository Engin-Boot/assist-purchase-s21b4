...
namespace BackendTests
{
    public class MailAleterControllerTests
    {
        ...
        readonly Backend.Controllers.MailAlertController _controller = new Backend.Controllers.MailAlertController(new Backend.Repository.MailAlerterRepository(@"C:\Users\Ajinkya\git repo\assist-purchase-s21b4\Segment1_API\BackendTests\TestCustomers.csv"));
        [Fact]
